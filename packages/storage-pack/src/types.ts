...
export interface PackingContext {
  /** Object storage with delta capabilities (includes getSize and listObjects) */
  objects: DeltaObjectStorage;
...
export interface PackingCandidate {
  ...
  path?: string;
  /** Object size in bytes (from getSize) */
  size: number;
...
/**
 * Storage analysis report produced by StorageAnalyzer
 */
...
/**
 * Options for candidate selection strategies
 */
export interface CandidateSelectorOptions {
  /** Maximum number of candidates to return */
  maxCandidates?: number;
  /** Minimum size ratio for candidates (default: 1/16 per JGit) */
  minSizeRatio?: number;
  /** Maximum size ratio for candidates */
  maxSizeRatio?: number;
  /** Include objects already stored as deltas */
  includeDeltaObjects?: boolean;
}
...
/**
 * Strategy for selecting delta base candidates
 */
export type CandidateStrategy = "size" | "path" | "tree-walking" | "combined";
