...
/**
 * Create the DeltaObjectStore test suite with a specific factory
 *
...
export function createDeltaObjectStorageTests(
  ...
  describe(`DeltaObjectStore [${name}]`, () => {
