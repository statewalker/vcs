 ...
 */
export async function* deserializePacks(blocks: AsyncIterable<Uint8Array>): AsyncGenerator<Packet> {
 ...
 */
export function createPacketTransport(blockSize: number = DEFAULT_BLOCK_SIZE): PacketTransport {
  return {
