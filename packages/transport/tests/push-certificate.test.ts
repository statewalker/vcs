/**
 * Push Certificate Specification Tests
 *
 * These tests document the expected behavior of Git push certificate functionality
 * that is NOT YET IMPLEMENTED in the source code. They serve as a specification
 ...
 *
 * STATUS: Specification tests - no corresponding src/ implementation exists.
 *         When implementing, create src/protocol/push-certificate.ts and add
 *         READ_CERTIFICATE, VALIDATE_CERTIFICATE states to server-push-fsm.ts.
 *
...
describe("PushCertificateParser", () => {
  describe("should parse certificate header", () => {
    ...
    it("rejects missing version", () => {
      const lines = ["pusher Test User <test@example.com>", "nonce abc123"];
  ...
  describe("should parse nonce", () => {
    ...
    it("rejects missing nonce", () => {
      const lines = ["certificate version 0.1", "pusher Test User <test@example.com>"];
  ...
  describe("should reject invalid certificates", () => {
    ...
    it("rejects certificate without pusher", () => {
      const lines = ["certificate version 0.1", "nonce abc123"];
  ...
  describe("should store certificates", () => {
    it("stores certificate by ref and oid", () => {
      ...
      const cert: PushCertificate = {
        ...
        nonce: "abc",
        commands: [{ oldOid: "a".repeat(40), newOid: "b".repeat(40), refName: "refs/heads/main" }],
      };
