/**
 * SQL implementation of DeltaBackend
 *
...
import { type Delta, deltaToGitFormat, deserializeDeltaFromGit } from "@webrun-vcs/diff";
import type {
  DeltaBackend,
  DeltaBackendStats,
  DeltaChainDetails,
 ...
 *
 * Implements DeltaBackend interface using SQLite for storage.
 * Stores delta instructions in Git binary format for efficient storage
 * and compatibility with Git tools.
 */
export class SQLDeltaBackend implements DeltaBackend {
  readonly name = "sql";
