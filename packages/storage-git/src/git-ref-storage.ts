 ...
 *
 * Implements the RefStorage interface for Git repositories,
...
import {
  type Ref as GitRef,
  RefStorage as GitRefStorageLocation,
...
/**
 * Convert Git-internal RefStorage to public RefStorageLocation
 */
function toRefStorageLocation(storage: GitRefStorageLocation): RefStorageLocation {
  switch (storage) {
    case GitRefStorageLocation.NEW:
      return RefStorageLocation.NEW;
    case GitRefStorageLocation.LOOSE:
      return RefStorageLocation.PRIMARY;
    case GitRefStorageLocation.PACKED:
      return RefStorageLocation.PACKED;
 ...
 * Git reference storage implementation
 *
 * Implements RefStorage for Git repositories using loose refs and packed-refs.
 */
export class GitRefStorage implements RefStorage {
