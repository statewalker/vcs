 ...
 *
 * Combines multiple ObjectStore implementations into a single unified interface.
 ...
 */
export class CompositeObjectStorage implements ObjectStore {
  private readonly primaryStorage: ObjectStore;
  private readonly fallbackStorages: ObjectStore[];
   ...
   */
  constructor(primaryStorage: ObjectStore, fallbackStorages: ObjectStore[] = []) {
