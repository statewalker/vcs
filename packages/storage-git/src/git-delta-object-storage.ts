 ...
 *
 * Implements DeltaObjectStorage interface for Git repositories.
 *
 * Architecture:
...
import { createDeltaRanges, deltaRangesToGitFormat } from "@webrun-vcs/diff";
import type {
  DeltaChainInfo,
  DeltaObjectStorage,
  DeltaOptions,
