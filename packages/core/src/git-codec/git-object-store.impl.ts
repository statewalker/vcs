...
import { loadWithHeader } from "../format/load-with-header.js";
import { encodeObjectHeader } from "../format/object-header.js";
import type { ObjectId, ObjectTypeString } from "../types/index.js";
import type { GitObjectHeader, GitObjectStore } from "./git-object-store.js";
