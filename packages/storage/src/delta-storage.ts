import type { DeltaBackend, DeltaBackendStats, DeltaChainDetails } from "./delta-backend.js";
import type {
 ...
 */
export interface DeltaStorage extends ObjectStorage {
  /**
