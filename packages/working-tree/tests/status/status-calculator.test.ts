...
import type { WorktreeEntry } from "../../src/worktree/index.js";
import type { Worktree } from "../../src/worktree/worktree.js";
 ...
 */
function createMockCommitStore(trees: Map<string, string>): Commits {
  return {
    store: vi.fn(),
    load: vi.fn(),
    has: vi.fn(),
