...
import { enqueueAddFile, enqueueInitRepo, enqueueRefreshRepo } from "../src/actions/index.js";
...
describe("RepositoryController", () => {
  ...
  describe("adding files", () => {
    ...
    it("should update commit count when a file is added", async () => {
      ...
      // Add a file
      enqueueAddFile(actionsModel, { name: "test-file.txt", content: "Hello, World!" });
      await flushPromises();
    ...
    it("should update commit count for multiple file additions", async () => {
      ...
      // Add first file
      enqueueAddFile(actionsModel, { name: "file1.txt", content: "Content 1" });
      await flushPromises();
      expect(repoModel.getState().commitCount).toBe(2);

      // Add second file
      enqueueAddFile(actionsModel, { name: "file2.txt", content: "Content 2" });
      await flushPromises();
      expect(repoModel.getState().commitCount).toBe(3);

      // Add third file
      enqueueAddFile(actionsModel, { name: "file3.txt", content: "Content 3" });
      await flushPromises();
    ...
    it("should update files list when file is added", async () => {
      ...
      // Add a file
      enqueueAddFile(actionsModel, { name: "new-file.txt", content: "Content" });
      await flushPromises();
    ...
    it("should update headCommitId when file is added", async () => {
      ...
      // Add a file
      enqueueAddFile(actionsModel, { name: "test.txt", content: "Content" });
      await flushPromises();
  ...
  describe("activity log", () => {
    ...
    it("should log file addition message", async () => {
      ...
      // Add a file
      enqueueAddFile(actionsModel, { name: "my-file.txt", content: "Content" });
      await flushPromises();
  ...
  describe("direct Git verification", () => {
    ...
    it("should store files in the repository", async () => {
      ...
      // Add a file
      enqueueAddFile(actionsModel, { name: "hello.txt", content: "Hello, World!" });
      await flushPromises();
