/**
 * Configuration constants for the example app.
 */

import * as path from "node:path";

/** Base directory for test repositories */
export const BASE_DIR = path.join(process.cwd(), "test-repos");

/** Remote (bare) repository directory */
