...
- `@statewalker/vcs-core` - Git storage, types, and interfaces
- `@statewalker/vcs-transport` - Git transport protocol (clone, push)
- `@statewalker/vcs-utils` - Compression and hash utilities
